...
def sentiment_analysis(input):
    ...
    user_sequences_matric = sequence.pad_sequences(user_sequences, maxlen=1225)
    predection = model.predict(user_sequences_matric)
    return round(float(predection[0][0]),2)
